CBGF_Fixed <-
function(n, gamm, heritability, a1=1, b1=25, Ped, covariates, geno, kin2, pos, order, beta_basis_F_BS, geno_basis_F_BS, base_F_BS = "bspline", beta_basis_F_FS, geno_basis_F_FS, base_F_FS ="fspline"){
...
#  p.valueIB_F_FS=davies(S_obsIB_F_FS, DIB_F_FS)$Qq
  ...
  ### Without IBS Kernel
  Fixed=cbind(gamm.hat[1], gamm.hat[2],gamm.hat[3], heritability_est, S_obsL_F_BS, p.valueL_F_BS, S_obsQ_F_BS, p.valueQ_F_BS, S_obsG_F_BS, p.valueG_F_BS, S_obsP_F_BS, p.valueP_F_BS, S_obsL_F_FS, p.valueL_F_FS, S_obsQ_F_FS, p.valueQ_F_FS, S_obsG_F_FS, p.valueG_F_FS, S_obsP_F_FS, p.valueP_F_FS)
  colnames(Fixed) =c("Intercept", "gam1", "gam2", "h.S_estim", "StatL.Fixed_Bs", "p.v_obsbL.Fixed_Bs","StatQ.Fixed_Bs", "p.v_obsbQ.Fixed_Bs", "StatG.Fixed_Bs", "p.v_obsbG.Fixed_Bs", "StatP.Fixed_Bs", "p.v_obsbP.Fixed_Bs", "StatL.Fixed_Fs", "p.v_obsbL.Fixed_Fs","StatQ.Fixed_Fs", "p.v_obsbQ.Fixed_Fs", "StatG.Fixed_Fs", "p.v_obsbG.Fixed_Fs", "StatP.Fixed_Fs", "p.v_obsbP.Fixed_Fs")
  rownames(Fixed) = NULL
