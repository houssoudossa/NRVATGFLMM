CBGF_Beta_Only <-
  function(heritability, a1=1, b1=25, Ped, covariates, geno, kin2, pos, order, beta_basis_BO_BS, base_BO_BS = "bspline", beta_basis_BO_FS,base_BO_FS = "fspline"){
    ...
    CBGF1=cbind(gamm.hat[1], gamm.hat[2],gamm.hat[3], heritability_est, S_obsL_BO_BS, p.valueL_BO_BS,S_obsQ_BO_BS,p.valueQ_BO_BS, S_obsG_BO_BS, p.valueG_BO_BS, S_obsP_BO_BS, p.valueP_BO_BS, S_obsL_BO_FS, p.valueL_BO_FS, S_obsQ_BO_FS, p.valueQ_BO_FS, S_obsG_BO_FS, p.valueG_BO_FS, S_obsP_BO_FS, p.valueP_BO_FS)
    colnames(CBGF1) =c("Intercept", "gam1", "gam2", "h.S_estim", "StatL.Beta_Bs", "p.v_obsbL.Beta_Bs", "StatQ.Beta_Bs", "p.v_obsbQ.Beta_Bs", "StatG.Beta_Bs", "p.v_obsbG.Beta_Bs", "StatP.Beta_Bs", "p.v_obsbP.Beta_Bs", "StatL.Beta_Fs", "p.v_obsbL.Beta_Fs","StatQ.Beta_Fs", "p.v_obsbQ.Beta_Fs", "StatG.Beta_Fs", "p.v_obsbG.Beta_Fs", "StatP.Beta_Fs", "p.v_obsbP.Beta_Fs") 
    rownames(CBGF1) = NULL
    return(as.data.frame(CBGF1))
  }
